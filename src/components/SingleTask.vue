<template>
  <div class="bg-white rounded-sm p-2 shadow-sm group flex">
    <div class="flex-1">
      <input class="placeholder-gray-400 w-full outline-none" placeholder="Untitled toodoo..." v-model="currentTitle"/>
    </div>
    <button @click="remove" class="transition-opacity opacity-0 group-hover:opacity-100 focus:outline-none focus:text-red-700">
